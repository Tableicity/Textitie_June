...
- [GitHub push askpass hang](github-push-askpass-hang.md) — Replit GUI/shell push hangs via replit-git-askpass (connection stuck on stale account); bypass with inline-PAT push; real fix = full disconnect+revoke+reconnect.
